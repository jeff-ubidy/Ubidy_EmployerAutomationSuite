...
Register new agency
    ...
    Input Text                          ${Login.Username.Text}                      agency_${random.username}
    Input Text                          ${Registration.CompanyName.Text}            agency_${random.username}
    Input Text                          ${Registration.FirstName.Text}              agency_${random.username}
    Input Text                          ${Registration.LastName.Text}               agency_${random.username}
    Input Text                          ${Registration.Email.Text}                  agency_${random.username}@ubidy.com
    ...
    Element Should Contain              ${Registration.UserName.Label}              Username: agency_${random.username}
    Element Should Contain              ${Registration.EmployerName.Label}          Employer Name: agency_${random.username}
    Element Should Contain              ${Registration.FirstName.Label}             First Name: agency_${random.username}
    Element Should Contain              ${Registration.LastName.Label}              Last Name: agency_${random.username}
    Element Should Contain              ${Registration.Email.Label}                 Email: agency_${random.username}@ubidy.com
    ...
    Run Keyword If                      ${isPresent}                                Log to console                                                      agency_${random.username} is already exists.
...
Create address
    ...
    lib.Ubidy.Text Should Be Equal      ${Address.Head.Office.Email.Label}          Email: testagency@mailinator.com
    #RegionalOffice------
    Log to console                      ${\n}
    ...
    lib.Ubidy.Text Should Be Equal      ${Address.Regional.Office.Email.Label}      Email: testagency1@mailinator.com
    #Correspondence----------
    Log to console                      ${\n}
    ...
    lib.Ubidy.Text Should Be Equal      ${Address.Correspondence.Office.Email.Label}    Email: testagency2@mailinator.com
    Set Selenium Implicit Wait          ${Selenium.Timeout}
    Set Selenium Timeout                ${Selenium.Timeout}
...
Create testimonials
    ...
    Input Text                          ${Testimonials.Email.Text}                          testagency@mailinator.com
    Capture Page Screenshot
    ...
    lib.Ubidy.Text Should Be Equal      ${Testimonials.Table.Email}                         testagency@mailinator.com
...
Profile preview
    ...
    lib.Ubidy.Text Should Be Equal      ${Profile.Preview.Email.Label}                      testagency@mailinator.com
    ...
    lib.Ubidy.Text Should Be Equal      ${Profile.Preview.AboutUs.Region.Email.Label}               testagency1@mailinator.com
    ...
    lib.Ubidy.Text Should Be Equal      ${Profile.Preview.AboutUs.Correspondence.Email.Label}       testagency2@mailinator.com
    ...
    lib.Ubidy.Text Should Be Equal      ${Profile.Preview.Testimonial.Label}                        testagency@mailinator.com
    Capture Page Screenshot
